"""
Script to test the functionality of random_crystal_2D. For each layer group (between 1 and 80), generates a 2d atomic crystal with the given parameters. Most of the command line options for molecular_crystal.py are also present here, with the addition of -t for the thickness of the cell. For each layer group, the number of atoms used to generate the crystal is equal to the multiplicity of the general position.
"""
...
if __name__ == "__main__":
    ...
    parser = OptionParser()
    parser.add_option("-e", "--atoms", dest="atoms", default='C', 
            help="desired atoms: e.g., C", metavar="atoms")
