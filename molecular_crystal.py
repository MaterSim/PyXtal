                	    	    ...
                	    	    #Generate a list of coords from ops
                                    ...
                                    if good_merge is not False:
                                        ...
                                        if check_distance_molecular(coordinates_tmp, coords_toadd, sites_tmp, i, cell_matrix, self.radii):
                                            ...
                                            possible = []
                                            for point in coords_toadd:
                                                generated1 = list(generator.operate(point) for generator in generators)
                                                generated1 -= np.floor(generated1)
                                                generated2 = list(wp.operate(point) for wp in self.wyckoffs[j][k])
                                                generated2 -= np.floor(generated2)
                                                #Check if generated1 is the same as generated2
                                                still_valid = True
                                                for index in range(len(generated1)):
                                                    if still_valid is True:
                                                        if not np.allclose(generated1[index], generated2[index], atol=.01):
                                                            still_valid = False
                                                            break
                                                if still_valid is True:
                                                    possible.append(point)
                                            if possible == []:
                                                print("Error: Could not re-generate Wyckoff position")
                                                return
                                            if len(possible) > 1:
                                                print("Found multiple Wyckoff positions")
                                                point = choose(possible)
                                            else:
                                                point = possible[0]
                                                '''print(point)
                                                generated = list(generator.operate(point) for generator in generators)
